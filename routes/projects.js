...
router.get("/:projectId/volunteer", authMiddleware.requireLogin, handleVolunteerSignup);
router.post("/:projectId/volunteer", authMiddleware.requireLogin, handleVolunteerSignup);
router.get("/:projectId/volunteer/remove", authMiddleware.requireLogin, handleVolunteerRemoval);
